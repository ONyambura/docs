...
import { IconBrandGithub, IconTag, IconFileText, IconDownload, IconBrandNpm, IconShoppingCart, IconBrandYoutube, IconWorld  } from '@tabler/icons-react';
...
export function TebexButton(props: Props) {
  return (
    <Button icon={<IconShoppingCart />} side={props.side} link={props.link}>
      {props.label || "Tebex Store"}
    </Button>
  );
}

// YouTube Button
export function YoutubeButton(props: Props) {
  return (
    <Button icon={<IconBrandYoutube />} side={props.side} link={props.link}>
      {props.label || "YouTube"}
    </Button>
  );
}
...
// FiveM / CFX Button
export function FivemButton(props: Props) {
  return (
    <Button icon={<IconWorld />} side={props.side} link={props.link}>
      {props.label || "CFX Forum"}
    </Button>
  );
}